# KneeSurgery
## UI preview
![UI](https://i.imghippo.com/files/hgn3365tQk.PNG)
![UI1](https://i.imghippo.com/files/hgNz9646Gs.PNG)
## Dll configuration
...
```csharp
        ...
        int result = await Task.Run(() => KneeSurgeryDll.KneeSurgery.AutoInjection())
```
- ### int Injection()
```csharp
        //SOURCE
